...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load(r'gallery\sprites\start.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load(r'gallery\sprites\base.png').convert_alpha()
    GAME_SPRITES['pipe'] =(pygame.transform.rotate(pygame.image.load(r'gallery\sprites\pipe.png').convert_alpha(), 180), 
    ...
    GAME_SPRITES['background'] = pygame.image.load(r'gallery\sprites\background.png').convert()
